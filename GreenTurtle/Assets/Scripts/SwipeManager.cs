...
//                    Debug.Log("[SwipeManager] Swipe was not long enough.");
	...
	public static bool SwipedCollider = false;
...
//				if (t.position != firstPressPos && Physics.Linecast (firstPressPos, t.position)) {
//					SwipedCollider = true;
//				} else
//					SwipedCollider = false;
				firstPressPos = t.position;
				IsSwiping = false;
//				Debug.Log("Touch pauses!");
			}
